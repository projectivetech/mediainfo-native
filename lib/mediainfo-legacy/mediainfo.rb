# NOTE: This is a copy of the source of the 'mediainfo' gem, to be found at 
# https://github.com/FlavourSys/mediainfo, or in its original version here
# https://github.com/greatseth/mediainfo. It has been slightly modified to
# to not use the mediainfo executable but instead the output of the native
# library.

require "forwardable"
require_relative "mediainfo/string"
require_relative "mediainfo/attr_readers"
...
class Mediainfo
  ...
  class << self  
    ...
    def mediainfo_native
      @mediainfo_native ||= MediaInfoNative::MediaInfo.new
    end
  end
  ...
  def mediainfo!
    raw_response = self.class.mediainfo_native.inform(@full_filename)
  end
